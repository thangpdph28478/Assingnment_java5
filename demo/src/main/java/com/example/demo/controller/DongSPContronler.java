...
public class DongSPContronler {

    @Autowired
    private DongSPService service;
    @Autowired
    private DongSPService cuaHangService;
    @Autowired
    private DongSPService chucVuService;

    @GetMapping("/hien-thi")
    public String hienThi(
            Model model,
//            @ModelAttribute("chucVu") DongSP chucVu,
        ...
        Page<DongSP> page = service.getAll(pageable);
    ...
    public String updateDongSP(Model model,
                               @PathVariable("id") UUID id,
                               @ModelAttribute("dulieuxem") DongSP nhanVien  // dùng form string
    ) {
        DongSP sp = service.getOne(id);
    ...
    public String viewadd(Model model,
                          @ModelAttribute("dulieuxem") DongSP nhanVien //vif dungf from string dulieuthem been add neu ko co dong ny se loi
