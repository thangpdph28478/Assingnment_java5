...
<%--/${dulieuxem.id}--%>
<form:form action="/gio-hang-chi-tiet/update/${dulieuxem.id.idGioHang.id}/${dulieuxem.id.idChiTietSP.id}" method="post"
    ...
    <table class="table " style="border: aliceblue 1px">
        ...
        <tr>
            ...
            <th>
                ...
                <form:select path="id.idGioHang" items="${giohang}" itemValue="id" itemLabel="ma" id="idhd"
                             disabled="true">
                </form:select>
        ...
        <tr>
            ...
            <th>
                <form:select path="id.idChiTietSP" items="${chitietsanpham}" itemValue="id" itemLabel="CTSP" id="idctsp"
                             disabled="true">
                </form:select>
