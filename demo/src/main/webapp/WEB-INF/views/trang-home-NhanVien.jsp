...
<form action="/nhan-vien/timkiem" method="post" style="float:right;margin-right:  15cm;">
    NHẬP TÊN: <input type="text" name="tenTK">
    <button class="btn btn-success" type="submit">TÌM</button>
</form>

<a class="btn btn-success" href="/nhan-vien/view-add" onclick="return myFunction4()">ADD</a>
...
<table class="table table-bordered border-primary">
    ...
    <c:forEach items="${dulieu}" var="ht" varStatus="">
        ...
        <tr>
            ...
            <td><a href="/nhan-vien/remove/${ht.id}" onclick="return myFunction1()" class="btn btn-success">DELETE</a>
            </td>

            <td><a href="/nhan-vien/view-update/${ht.id}" onclick="return myFunction3()"
