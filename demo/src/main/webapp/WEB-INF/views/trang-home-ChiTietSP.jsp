...
<a class="btn btn-success" href="/chi-tiet-sp/view-add" onclick="return myFunction4()">ADD</a>
...
<table class="table table-bordered border-primary">
    ...
    <c:forEach items="${dulieu}" var="ht" varStatus="">
        <tr>
            ...
            <td><a href="/chi-tiet-sp/remove/${ht.id}" onclick="return myFunction1()"
                   class="btn btn-success">DELETE</a></td>


            <td><a href="/chi-tiet-sp/view-update/${ht.id}" onclick="return myFunction3()"
...
<nav aria-label="Page navigation example">
    <ul class="pagination justify-content-center pagination-lg">
        ...
        <c:forEach begin="1" end="${total}" varStatus="status">
            <li class="page-item">
                <a href="${pageContext.request.contextPath}/chi-tiet-sp/hien-thi?pageNum=${status.index -1}"
