...
<form action="/chuc-vu/timkiem" method="post" style="float:right;margin-right:  15cm;">
    NHẬP TÊN: <input type="text" name="tenTK">
    <button class="btn btn-success" type="submit">TÌM</button>
</form>

<a class="btn btn-success" href="/chuc-vu/view-add" onclick="return myFunction4()">ADD</a>
...
<table class="table table-bordered border-primary">
    ...
    <c:forEach items="${dulieu}" var="ht" varStatus="">
        ...
        <tr>
            ...
            <td><a href="/chuc-vu/remove/${ht.id}" onclick="return myFunction1()" class="btn btn-success">DELETE</a>
            </td>

            <td><a href="/chuc-vu/view-update/${ht.id}" onclick="return myFunction3()"
